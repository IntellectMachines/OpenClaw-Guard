 ...
 */
export declare enum GuardDecision {
    ALLOW = "ALLOW",
    DENY = "DENY",
    FLAG = "FLAG"
}
...
export declare class SecurityException extends Error {
    ...
    constructor(message: string, decision: GuardDecision, decisionId: string, moderationNotes: string, toolName: string);
}
/**
 ...
 */
export declare class TokenVendingException extends Error {
